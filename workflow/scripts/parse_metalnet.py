...
header (muestra__familia__id_original) y la cruza con provenance.tsv.
"""
import pandas as pd
from pathlib import Path

SEP = "__"   # mismo separador que collect_candidates.py
...
# >>> EDITAR: nombre real de la columna de ID de proteina en pred_pairs.tsv <<<
